      ...
      <aside className="fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 border-r border-amber-500/20 z-50 flex flex-col">
            ...
            <Link href="/" className="flex items-center gap-3" onClick={() => onOpenChange(false)}>
              <div className="rounded-lg ring-2 ring-amber-500/50 bg-zinc-900 p-1 shadow-amber-500/20 shadow-lg">
                <img
                  src="/logo.png"
                  alt="HAIDER DIAMONDS"
                  className="h-9 w-auto brightness-125 contrast-125 drop-shadow-[0_0_4px_rgba(245,158,11,0.3)]"
                />
              </div>
              <span className="text-amber-400 font-semibold drop-shadow-[0_0_2px_rgba(245,158,11,0.2)]">
                HAIDER DIAMONDS
              </span>
            </Link>
            <Button
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="space-y-4">
            <h3 className="text-amber-400 font-semibold text-sm">Contact Info</h3>
          ...
          <div className="mt-8">
            <h3 className="text-amber-400 font-semibold text-sm mb-4">Follow Us</h3>

...
const products: Product[] = [
  ...
  { slug: "halo-diamond-ring", title: "Halo Diamond Ring", price: "PKR 499,000", image: "/placeholder.jpg" },
  { slug: "vintage-cushion-ring", title: "Vintage Cushion Ring", price: "PKR 579,000", image: "/placeholder.jpg" },
]
  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-amber-400 mb-6 font-serif">Rings</h1>

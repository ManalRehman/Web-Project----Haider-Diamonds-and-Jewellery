...
<<<<<<< HEAD
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-blue-600 mb-4 font-serif">Create Your Dream Jewelry</h1>
            ...
            <Card className="bg-white border border-blue-200 shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-blue-600 font-semibold">Consultation</h4>
                    <p className="text-slate-600 text-sm">We discuss your vision and requirements</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="text-blue-600 font-semibold">Design</h4>
                    <p className="text-slate-600 text-sm">Our designers create detailed sketches</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="text-blue-600 font-semibold">Crafting</h4>
                    <p className="text-slate-600 text-sm">Master craftsmen bring your design to life</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="text-blue-600 font-semibold">Delivery</h4>
                    <p className="text-slate-600 text-sm">Your custom piece is delivered safely</p>
=======
            <Card className="bg-zinc-900 border border-amber-500/20">
              <CardHeader>

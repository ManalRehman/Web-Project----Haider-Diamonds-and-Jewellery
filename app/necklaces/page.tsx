...
const products: Product[] = [
  { slug: "diamond-tennis-necklace", title: "Diamond Tennis Necklace", price: "PKR 599,000", image: "/luxury-diamond-tennis-necklace-with-brilliant-cut.jpg" },
  { slug: "solitaire-pendant-necklace", title: "Solitaire Pendant Necklace", price: "PKR 359,000", image: "/elegant-diamond-necklace-with-pendant-on-luxury-je.jpg" },
  { slug: "pear-halo-necklace", title: "Pear Halo Necklace", price: "PKR 549,000", image: "/placeholder.jpg" },
]
  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-amber-400 mb-6 font-serif">Necklaces</h1>

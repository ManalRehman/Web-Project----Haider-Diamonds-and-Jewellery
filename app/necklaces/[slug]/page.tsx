...
const products: Product[] = [
  { slug: "diamond-tennis-necklace", title: "Diamond Tennis Necklace", price: "PKR 599,000", images: ["/luxury-diamond-tennis-necklace-with-brilliant-cut.jpg", "/placeholder.jpg"] },
  { slug: "solitaire-pendant-necklace", title: "Solitaire Pendant Necklace", price: "PKR 359,000", images: ["/elegant-diamond-necklace-with-pendant-on-luxury-je.jpg"] },
  { slug: "pear-halo-necklace", title: "Pear Halo Necklace", price: "PKR 549,000", images: ["/placeholder.jpg"] },
]
    ...
    <div className="bg-zinc-950 min-h-screen text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="mb-6 text-amber-500 text-sm">
          ...
          <Link href="/necklaces" className="hover:text-amber-400">Necklaces</Link>
          <span className="mx-2 text-amber-500/60">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-amber-100/80 leading-relaxed mb-4">
              A continuous strand of perfectly matched brilliant-cut diamonds, crafted to sit gracefully along the neckline with luminous fire.
            </p>

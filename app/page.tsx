...
export default function HaiderDiamonds() {
  ...
  return (
    <div className="bg-zinc-950 text-white overflow-x-hidden custom-scrollbar">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="h-16 flex items-center ml-20 md:ml-12">
              <div className="relative group">
                <img
                  src="/logo.png"
                  alt="HAIDER DIAMONDS"
                  className="h-16 w-24 group-hover:scale-110 transition-all duration-300 cursor-pointer drop-shadow-lg group-hover:drop-shadow-2xl group-hover:drop-shadow-amber-500/50"
                />
            ...
            <div className="flex items-center space-x-4">
              <div className="hover:scale-125 hover:rotate-12 transition-all duration-300">
                <Search className="w-5 h-5 text-amber-500 cursor-pointer" />
              </div>
              <div className="hover:scale-125 hover:rotate-12 transition-all duration-300">
                <ShoppingBag className="w-5 h-5 text-amber-500 cursor-pointer" />
              </div>
              <div className="hover:scale-110 transition-all duration-300">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-amber-500 hover:text-white hover:bg-amber-500/20 hover:scale-105"
                >
              ...
              <div className="hover:scale-110 transition-all duration-300">
                <Button
                  size="sm"
                  className="bg-amber-500 text-black hover:bg-amber-600 hover:scale-105 hover:shadow-lg hover:shadow-amber-500/30"
                >
      ...
      {/* Sidebar Toggle */}
      <button
        className="fixed top-4 left-4 z-50 bg-amber-500 text-black p-3 rounded-full hover:bg-amber-600 transition-all duration-300 hover:scale-125 hover:rotate-180 hover:shadow-xl hover:shadow-amber-500/50"
      ...
      <section id="home" className="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-amber-500 via-amber-300 to-amber-100 bg-clip-text text-transparent font-serif md:text-4xl animate-fade-in-up">
            HAIDER DIAMONDS & JEWELLERY
          </h1>

          <h2
            className="text-2xl md:text-3xl text-amber-500 mb-8 font-serif italic animate-fade-in-up"
          ...
          <p
            className="text-lg md:text-xl text-amber-100/80 mb-12 animate-fade-in-up"
          ...
          >
            <div className="hover:scale-110 transition-all duration-300 hover:-translate-y-2">
              <Button className="bg-gradient-to-r from-amber-500 to-amber-400 text-black px-8 py-4 rounded-full font-semibold hover:from-amber-600 hover:to-amber-500 hover:shadow-2xl hover:shadow-amber-500/40">
                START CUSTOM DESIGN
              </Button>
            </div>
            <div className="hover:scale-110 transition-all duration-300 hover:-translate-y-2">
              <Button
                variant="outline"
                className="border-2 border-amber-500 text-amber-500 px-8 py-4 rounded-full font-semibold hover:bg-amber-500 hover:text-black bg-transparent hover:shadow-2xl hover:shadow-amber-500/40"
              >
                VIEW COLLECTIONS
              </Button>
            </div>
      ...
      <section id="custom-design" className="py-20 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-amber-500 mb-6 font-serif animate-fade-in-up">
            CUSTOM DESIGN PROCESS
          </h2>
          <p className="text-amber-100/70 mb-12 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-6xl font-bold text-amber-500/20 mb-4 hover:text-amber-500 hover:scale-125 transition-all duration-500 hover:rotate-12">
                  {item.step}
                </div>
                <p className="text-amber-100 font-medium hover:text-amber-300 transition-colors duration-300">
                  {item.title}
                </p>
      ...
      <section id="signature-pieces" className="py-20 bg-zinc-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-amber-500 mb-6 font-serif animate-fade-in-up">SIGNATURE PIECES</h2>
          <p className="text-amber-100/70 mb-12 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.title}
                className="p-6 bg-zinc-950 rounded-lg border border-amber-500/30 group overflow-hidden hover:-translate-y-4 hover:border-amber-500 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 hover:scale-105 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.1 + 0.2}s` }}
              >
                <div className="relative mb-6 overflow-hidden rounded-lg group-hover:scale-110 transition-transform duration-500">
                ...
                <h3 className="text-xl text-amber-500 mb-2 font-semibold group-hover:scale-105 transition-transform duration-300">
                  {item.title}
                </h3>
                <p className="text-amber-100/70 group-hover:text-amber-100 transition-colors duration-300">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-left">
            <h2 className="font-bold text-amber-500 mb-6 font-serif text-2xl">
            ...
            <ul className="space-y-2 text-amber-100/80">
              {["Certified Authenticity", "Ethically Sourced Diamonds", "Lifetime Guarantee"].map(
                (item, index) => (
                  ...
                  >
                    <Check className="w-5 h-5 text-amber-500 mr-3 hover:scale-125 transition-transform duration-300" />
                    {item}
                  </li>
                ),
              )}
          ...
          <div className="flex items-center justify-center animate-fade-in-right">
            <div className="relative">
              <div className="animate-spin-slow hover:animate-pulse">
                <Gem className="w-20 h-20 text-amber-500/70 hover:text-amber-500 hover:scale-125 transition-all duration-500" />
              </div>
              <div className="absolute inset-0 animate-ping">
                <Gem className="w-20 h-20 text-amber-500/20" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Customer Reviews */}
      <section ref={reviewsRef} className="py-20 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-amber-500 mb-6 font-serif animate-fade-in-up">CUSTOMER REVIEWS</h2>
          <p className="text-amber-100/70 mb-12 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={review.name}
                className="p-6 bg-zinc-950 rounded-lg border border-amber-500/30 group hover:-translate-y-4 hover:border-amber-500 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 hover:scale-105 animate-fade-in-up"
                style={{ animationDelay: `${index * 0.1 + 0.2}s` }}
              >
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full flex items-center justify-center text-black font-bold text-lg hover:scale-125 hover:rotate-12 transition-all duration-500 hover:shadow-lg hover:shadow-amber-500/50">
                    {review.initials}
                  </div>
                </div>
                ...
                <p className="text-amber-100/80 mb-6 italic leading-relaxed group-hover:text-amber-100 transition-colors duration-300">
                  "{review.review}"
                </p>

                <h4 className="text-amber-500 font-semibold hover:scale-110 transition-transform duration-300">
                  {review.name}
                </h4>
              </div>
            ))}
      ...
      <section id="contact" className="py-20 bg-zinc-800">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-amber-500 mb-6 font-serif">GET IN TOUCH</h2>
          <p className="text-amber-100/70 mb-12">Ready to create your perfect piece? Contact us today.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-amber-100/80">info@haiderdiamonds.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center">
                    <Phone className="w-4 h-4 text-black" />
                  </div>
                  <span className="text-amber-100/80">+92 300 1234567</span>
                </div>
            ...
            <div>
              <div className="bg-zinc-950 p-8 rounded-lg border border-amber-500/30">
                <h3 className="text-xl font-semibold text-amber-500 mb-6">Send us a Message</h3>
                <form className="space-y-4">
                  <input
                    type="text"
                    placeholder="Your Name"
                    className="w-full p-3 bg-zinc-800 border border-amber-500/30 rounded-lg text-white placeholder-amber-100/50 focus:border-amber-500 focus:outline-none"
                  />
                  <input
                    type="email"
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full p-3 bg-zinc-800 border border-amber-500/30 rounded-lg text-white placeholder-amber-100/50 focus:border-amber-500 focus:outline-none resize-none"
                  ></textarea>
                  <Button className="w-full bg-amber-500 text-black hover:bg-amber-600">Send Message</Button>
                </form>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-zinc-800 py-12 border-t border-amber-500/20">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="animate-fade-in-up">
            <h3 className="font-bold text-amber-500 mb-4 font-serif text-lg">HAIDER DIAMONDS &amp; JEWELLERY </h3>
            <p className="text-amber-100/70 mb-4">Where Elegance Meets Perfection</p>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <h4 className="text-amber-500 mb-4 font-semibold">Services</h4>
            <ul className="space-y-2 text-amber-100/70">
              <li className="cursor-pointer transition-all duration-300 hover:translate-x-2 hover:text-amber-500 hover:scale-105">
                Custom Designs
              </li>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <h4 className="text-amber-500 mb-4 font-semibold">Connect</h4>
            <div className="flex space-x-4">
              {[Instagram, Facebook, Twitter].map((IconComponent, index) => (
                <div
                  key={index}
                  ...
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <IconComponent className="w-6 h-6 text-amber-500 cursor-pointer hover:text-amber-400 transition-colors duration-300 hover:drop-shadow-lg hover:drop-shadow-amber-500/50" />
                </div>
              ))}
            </div>
          </div>
